...
(function($, $u) {
        ...
        __GLOBAL_API_FUNCTIONS__ = function($this) {
            ...
            return {
                ...
                hasattr: function(a) {
                    ...
                    return tedApi.attr(this.self, a);
    ...
    tedApi = {
        ...
        text: function(el, a) {
            ...
            return ((tedApi.isElement(el) || tedApi.isTextNode(el)) ? (typeof a === typeof $u ? (tedApi.isTextNode(el) || tedApi.isCommentNode(el) ? el.nodeValue : el.textContent) : (tedApi.isTextNode(el) || tedApi.isCommentNode(el) ? el.nodeValue = a : el.textContent = a)) : undefined)
        ...
        onFrame: function(callback) {
            ...
            var $_callback = window.requestAnimationFrame ||
        ...
        */
        ...
        http: function(r) {
            ...
            var jsp, i = 0,
                ...
                SettingHttp = tedApi.httpSetting(typeof r == "string" ? {
            ...
            if (SettingHttp.method.toUpperCase() == "JSONP") { //url, type , callback , repeat
                ...
                function JSONPFUNC() {
                    ...
                    return (new Promise(function(resolve, reject) {
                        ...
                        script.src = !SettingHttp.data.isEmpty() ? script.src + "&" + tedApi.serialize(SettingHttp.data) : script.src;
                ...
                function AJAXFN() {
                    ...
                    if (!SettingHttp.data.isEmpty()) {
                        ...
                        if (SettingHttp.method == "GET") {
                            ...
                            url = /\?[\d\w]+\=/.test(url) ? url + "&" + tedApi.serialize(SettingHttp.data) : url + "?" + tedApi.serialize(SettingHttp.data);
