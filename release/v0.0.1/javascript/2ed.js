...
(function($, $u) {
    ...
    var
        ted = {},
        Ted_Native_Setting = {
            url: "http://tedapi.poryagrand.ir/cdn/",
            libError: ""
        },
        _style,
        Elms = {},
    ...
    tedApi = {
        ...
        equation: function(x1, x2, x3) { //create equatin of 3 point in graph that start from [0,0]
            ...
            this.time = function(x, v) { //return time of each point
                var PoiNt = Math.min(THAT.inverse(0).x1, THAT.inverse(0).x2) + 0.10;
                var g = 9.8,
                ...
                var Third = tedApi.floatPoint((-1 * First) - Second, 7);
        ...
        */
        ...
        warn: function(a) {
            return typeof $u === typeof a ? $u : $.console.warn(a);
        },
        log: function(a) {
                        ...
                        function InChange(element, ev) {
                            ...
                            var change = new MutationObserver(function(objs) {
                                objs.forEach(function(obj) {
                                    if (obj.type == "childList") {
                                        if (isSet) {
                                            if (obj.target !== element && obj.target.tagName.toLowerCase() == eventT.toLowerCase()) {
                                                var objectT = {};
                                                if (obj.addedNodes.length == 0) {
                                                    objectT["type"] = "remove";
                                                    objectT["value"] = obj.removedNodes;
